...
public class FabricOfClientStatesJfx implements IFabricOfClientStates {
    ...
    @Override
    public LocalClientState02ConnectNonIdent getClientState02ConnectNonIdent(ClientStateAutomaton clientStateAutomaton) {
        return new LocalClientState02ConnectNonIdent(clientStateAutomaton);
    }

    @Override
    public LocalClientState04GameTypeSetSelected getClientState04GameTypeSetSelected(ClientStateAutomaton clientStateAutomaton) {
        return new LocalClientState04GameTypeSetSelected(clientStateAutomaton);
    }

    @Override
    public LocalClientState06GameMatchSetSelected getClientState06GameMatchSetSelected(ClientStateAutomaton clientStateAutomaton) {
        return new LocalClientState06GameMatchSetSelected(clientStateAutomaton);
    }

    @Override
    public LocalClientState07GameMatchSelected getClientState07GameMatchSelected(ClientStateAutomaton clientStateAutomaton) {
