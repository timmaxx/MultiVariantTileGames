...
public class FabricOfClientStatesJfx<Model> implements IFabricOfClientStates<Model> {
    private ClientStateAutomaton<Model> clientStateAutomaton;

    @Override
    public ClientState01NoConnect<Model> getClientState01NoConnect() {
        return new LocalClientState01NoConnect<>(clientStateAutomaton);
    }

    @Override
    public ClientState02ConnectNonIdent<Model> getClientState02ConnectNonIdent() {
        return new LocalClientState02ConnectNonIdent<>(clientStateAutomaton);
    }

    @Override
    public ClientState03ConnectAuthorized<Model> getClientState03ConnectAuthorized() {
        return new LocalClientState03ConnectAuthorized<>(clientStateAutomaton);
    }

    @Override
    public ClientState04GameTypeSetSelected<Model> getClientState04GameTypeSetSelected() {
        return new LocalClientState04GameTypeSetSelected<>(clientStateAutomaton);
    }

    @Override
    public ClientState05GameTypeSelected<Model> getClientState05GameTypeSelected() {
        return new LocalClientState05GameTypeSelected<>(clientStateAutomaton);
    }

    @Override
    public ClientState06GameMatchSetSelected<Model> getClientState06GameMatchSetSelected() {
        return new LocalClientState06GameMatchSetSelected<>(clientStateAutomaton);
    }

    @Override
    public ClientState07GameMatchSelected<Model> getClientState07GameMatchSelected() {
        return new LocalClientState07GameMatchSelected<>(clientStateAutomaton);
    }

    @Override
    public ClientState08GameIsPlaying<Model> getClientState08GameIsPlaying() {
        return new LocalClientState08GameIsPlaying<>(clientStateAutomaton);
    }
