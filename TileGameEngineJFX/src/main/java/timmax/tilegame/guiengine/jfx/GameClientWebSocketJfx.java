...
public abstract class GameClientWebSocketJfx extends Application {
    ...
    public void start( Stage primaryStage) throws URISyntaxException {
        ...
        GameStackPaneController gameStackPaneController = initGameStackPaneController( netModel, transportOfController);
        ...
        GameSceneController gameSceneController = initGameSceneController( netModel, transportOfController);
    ...
    abstract protected GameSceneController initGameSceneController( BaseModel baseModel, TransportOfController transportOfController);

    abstract protected GameStackPaneController initGameStackPaneController( BaseModel basemodel, TransportOfController transportOfController);
}