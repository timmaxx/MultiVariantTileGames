...
public class Route {
    ...
    // Но прокрутке назад не получится, т.к. не понятно был-ли во время хода двиг ящика. Достаточно сохранить true или false, о том был-ли сдвинут ящик!
    ...
    private Stack< Step> stackOfSteps = new Stack< >( );
    ...
    /**
     * Читает из маршрута произвольный шаг.
     */
    /*
    private Step elementAt( int index) {
        return stackOfSteps.elementAt( index);
    }
*/
    /**
     * Размер маршрута.
