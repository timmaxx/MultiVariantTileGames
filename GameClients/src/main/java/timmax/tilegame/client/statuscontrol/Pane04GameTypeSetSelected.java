...
public class Pane04GameTypeSetSelected extends AbstractConnectStatePane {
    ...
    public Pane04GameTypeSetSelected(ISenderOfEventOfClient senderOfEventOfClient) {
        ...
        nextStateButton.setOnAction(event -> {
            ...
            disableAllControls();
            //  Warning:(41, 47) Unchecked assignment: 'timmax.tilegame.basemodel.protocol.server.GameType' to 'timmax.tilegame.basemodel.protocol.server.GameType<timmax.tilegame.basemodel.dto.GameMatchDto>'
