...
public class LocalClientState05GameTypeSelected extends ClientState05GameTypeSelected<GameMatchId> {
    public LocalClientState05GameTypeSelected(ClientStateAutomaton<GameMatchId> clientStateAutomaton) {
