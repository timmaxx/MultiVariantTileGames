...
public class CS04GameTypeSetSelected<Model> extends AStateOfMVTGClient<Model> {
    private Set<ModelOfServerDescriptor> setOfModelOfServerDescriptor; // ---- 4 (Список типов игр)
    ...
    protected void _setGameTypeSet(Set<ModelOfServerDescriptor> setOfModelOfServerDescriptor) {
        this.setOfModelOfServerDescriptor = setOfModelOfServerDescriptor;
    }

    protected Set<ModelOfServerDescriptor> _getGameTypeSet() {
        return setOfModelOfServerDescriptor;
    }

    protected void _forgetGameTypeSet() {
        setOfModelOfServerDescriptor = null;
    }
}
