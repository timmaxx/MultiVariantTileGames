...
public interface TransportOfClient {
    ...
    void startGameMatch(int width, int height, Map<String, Integer> mapOfParamsOfModelValue);          //  7 -> 8  void startGameMatch(Map<String, Integer> mapOfParamsOfModelValue);
